...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_list:
        ...
        if (county_vote_percentage > winning_percentage_county) and (county_vote_count > winning_count_county):
    ...
    largestTurnout = (
        ...
        f"-------------------------\n")
    print(largestTurnout)
    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(largestTurnout)
